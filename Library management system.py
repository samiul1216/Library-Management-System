...
if __name__ == "__main__":
    ...
    Daffodillibrary = Library(
        ["c++", "python", "java", "oop in java", "macroeconomics", "microeconomics"])
    student = Student()
    track = []
    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                Daffodillibrary.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                Daffodillibrary.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                Daffodillibrary.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                Daffodillibrary.donateBook(student.donateBook())
